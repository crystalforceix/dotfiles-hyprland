...
sudo pacman -S --needed --noconfirm hyprland wofi playerctl kitty brightnessctl swaybg wl-clipboard noto-fonts-cjk thunar thunar-archive-plugin grim slurp xdg-desktop-portal-hyprland
...
yay -S --noconfirm quickshell-git sysstat papirus-icon-theme otf-comicshanns-nerd swww
