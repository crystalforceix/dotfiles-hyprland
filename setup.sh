...
sudo pacman -S --needed --noconfirm hyprland wofi kitty brightnessctl swaybg wl-clipboard noto-fonts-cjk thunar thunar-archive-plugin grim slurp xdg-desktop-portal-hyprland
