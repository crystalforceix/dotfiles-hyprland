...
sudo pacman -S --needed --noconfirm hyprland wofi kitty brightnessctl swaybg wl-clipboard otf-comicshanns-nerd noto-fonts-cjk thunar thunar-archive-plugin grim slurp xdg-desktop-portal-hyprland
...
yay -S --noconfirm quickshell sysstat adwaita-icon-theme
